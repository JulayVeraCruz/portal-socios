    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PortalSocios.Models.SociosBD>
    {
        ...
        protected override void Seed(PortalSocios.Models.SociosBD context) {
            ...
            var socios = new List<Socios> {
                new Socios {SocioID = 1, NumSocio = 1, Nome = "Simão Alvito Modesto", BI = "10325782", NIF = "172596295", DataNasc = new DateTime(1962,2,6), Email = "simao_modesto@gmail.com", Telemovel = "913567285", Morada = "Rua dos Armazéns N.º 40", CodPostal = "5743-247 TORRES NOVAS", Fotografia = "samodesto.jpg", DataInscr = new DateTime(2017,1,6), CategoriaFK = 1},
                new Socios {SocioID = 2, NumSocio = 2, Nome = "Maria Gonçalves Sousa", BI = "13728586", NIF = "498953925", DataNasc = new DateTime(1991,8,24), Email = "maria_sousa@gmail.com", Telemovel = "916258358", Morada = "Rua 1º de Dezembro N.º 2 - 3 Esq.", CodPostal = "2485-632 TOMAR", Fotografia = "mgsousa.jpg", DataInscr = new DateTime(2017,1,10), CategoriaFK = 1},
                new Socios {SocioID = 3, NumSocio = 3, Nome = "Miguel Alves Almeida", BI = "16259232", NIF = "632158329", DataNasc = new DateTime(2002,10,30), Email = "miguelaalmeida@outlook.com", Telemovel = "914752861", Morada = "Rua Vale Miguel N.º 10", CodPostal = "2485-215 TOMAR", Fotografia = "maalmeida.jpg", DataInscr = new DateTime(2017,1,19), CategoriaFK = 2},
                new Socios {SocioID = 4, NumSocio = 4, Nome = "Manuela Silva Rocha", BI = "18325025", NIF = "628102144", DataNasc = new DateTime(2006,5,13), Email = "manuela_rocha@hotmail.com", Telemovel = "961471852", Morada = "Travessa do Parque N.º 88", CodPostal = "4257-156 LISBOA", Fotografia = "msrocha.jpg", DataInscr = new DateTime(2017,1,28), CategoriaFK = 3},
                new Socios {SocioID = 5, NumSocio = 5, Nome = "André Filipe Melo Barbosa", BI = "11823582", NIF = "294953732", DataNasc = new DateTime(1982,12,12), Email = "andrefm.barbosa@gmail.com", Telemovel = "962148215", Morada = "Rua do Pelourinho N.º 1 - 2 Dir.", CodPostal = "4257-742 LISBOA", Fotografia = "afmbarbosa.jpg", DataInscr = new DateTime(2017,2,3), CategoriaFK = 1},
            ...
            var quotas = new List<Quotas> {
                ...
                new Quotas {QuotaID = 2, Montante = 6, Ano = 2017, Periodicidade = "Mensal", CategoriaFK = 2},
                new Quotas {QuotaID = 3, Montante = 3, Ano = 2017, Periodicidade = "Mensal", CategoriaFK = 3}
            };
